package com.mvmt.project.p2.security.config;
...
import com.mvmt.project.p2.security.CustomUserDetailsService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests()
                .antMatchers("/", "/api/user/loginerror", "/api/user/login", "/user/login", "/user/signup", "/api/user/signup").permitAll() // 예외 경로
